...
(
	...
	distrib_customer_id  varchar(10),
	cust_nm varchar2(30),
	addr_1 varchar2(30),
	addr_2 varchar2(30),
	city varchar2(25),
...
create table etl_sale (
	...
	etl_file_id number(9) not null,
	distrib_Id      number(10) not null,
	mfr_id          number(10) not null,
        mfr_product_id  number(10),	
	ship_to_cust_id number(10) not null,
	invoice_cd      number(10),	
	invoice_dt date,
       	ship_dt  date,	
